#pragma checksum "C:\Users\Sadiq\Desktop\ASP.NET\Layout_FrontToBack\FrontToBack\Front-to-back\Front-to-back\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "536891675d6bb9756571cbfb17e3b057d05da4d6"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"536891675d6bb9756571cbfb17e3b057d05da4d6", @"/Views/Home/Index.cshtml")]
    ...
    public class Views_Home_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "C:\Users\Sadiq\Desktop\ASP.NET\Layout_FrontToBack\FrontToBack\Front-to-back\Front-to-back\Views\Home\Index.cshtml"
                ...
                <div class=""carousel-item active"">
                    ...
                    <div class=""py-5 row d-flex align-items-center"">
                        <div class=""banner-content col-lg-8 col-8 offset-2 m-lg-auto text-left py-5 pb-5"">
                            <h1 class=""banner");
            WriteLiteral(@"-heading h1 text-secondary display-3 mb-0 pb-5 mx-0 px-0 light-300 typo-space-line"">
...
<section class=""container overflow-hidden py-5"">
    <div class=""row gx-5 gx-sm-3 gx-lg-5 gy-lg-5 gy-3 ");
            WriteLiteral(@"pb-3 projects"">
        ...
        <div class=""col-xl-3 col-md-4 col-sm-6 project ui graphic"">
            <a href=""#"" class=""service-work card border-0 text-white shadow-sm ove");
            WriteLiteral(@"rflow-hidden mx-5 m-sm-0"">
    ...
    ");
            ...
            <a href=""#"" class=""service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0"">
                ...
                <div class=""service-work-vertical card-img-overlay d-flex align-items-end"">
                    <div class=""service-work-content text-left text-light"">
                        ...
                        <p cla");
            WriteLiteral(@"ss=""card-text"">Lorem ipsum dolor sit amet, consectetur adipisicing</p>
                    </div>
                </div>
            </a>
        </div><!-- End Recent Work -->
        ...
        <div class=""col-xl-3 col-md-4 col-sm-6 project branding"">
            <a href=""#"" class=""service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0"">
                <img class=""ca");
            WriteLiteral(@"rd-img"" src=""./assets/img/services-07.jpg"" alt=""Card image"">
                <div class=""service-work-vertical card-img-overlay d-flex align-items-end"">
                    <div class=""service-work-content text-left text-light"">
        ...
        <div class=""col-xl-3 col-md-4 col-sm-6 project ui graphic branding"">
            <a href=""#"" class=""service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0"">
                ...
                <div class=""service-work-vertical card-img-overlay d-flex align-items-end"">
                    <div class=""service-work-content te");
            WriteLiteral(@"xt-left text-light"">
    ...
    <div class=""container py-5"">
        <div class=""row d-flex justify-content-center text-center"">
            ...
            <div class=""col-lg-3 col-12 pt-4"">
                <a hre");
            WriteLiteral(@"f=""#"" class=""btn btn-primary rounded-pill btn-block shadow px-4 py-2"">View Our Work</a>
            </div>
        </div>
    </div>
</section>
         ...
         ");
            ...
            <div class=""col-md-4 mb-3"">
                <a href=""#"" class=""recent-work card border-0 shadow-lg overflow-hidden"">
                    ...
                    <div class=""rece");
            WriteLiteral(@"nt-work-vertical card-img-overlay d-flex align-items-end"">
                        <div class=""recent-work-content text-start mb-3 ml-3 text-dark"">
